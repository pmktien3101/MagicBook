<%-- 
    Document   : home
    Created on : Jan 29, 2024, 1:54:39 PM
    Author     : MSI PC
--%>
...
<html lang="en">
    <head>
        ...
        <style>
            ...
            .friend-list ul li.user {
                margin-bottom: 10px;
                border: 1px solid black;
                border-radius: 5px;
                padding: 10px;
            }
            .friend-list ul li.user .username a {
                text-decoration: none;
                color: #333;
                font-weight: bold;
            }
    ...
    <body>
        ...
        <%
            //       ArrayList<Emotion> listEmotion = (ArrayList<Emotion>) session.getAttribute("LIST_EMOTION");
            //     System.out.println("Before setting LIST_EMOTION: "+ listEmotion);
            //     if (listEmotion == null) {
            //        listEmotion = (ArrayList<Emotion>) new ArrayList<Emotion>();
            //        session.setAttribute("LIST_EMOTION", listEmotion);
            //    }
                        ...
                        <div class="post-header">
                            <c:choose>
                                <c:when test="${post.shared == true}">
                                    ...
                                    <c:choose>
                                        <c:when test="${post.email.email==account.getEmail()}">
                                            <div class="edit-icon">
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                        <form action="AccountPage" method="Post">
                                                            <input type="hidden" name="action" value="deletePostHome">
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                        <form action="ReportPage" method="Post">
                                                            <input type="hidden" name="action" value="loadReportForm">
                                                            <input type="hidden" name="pid" value="${post.id}">
                                                            <button type="submit" class="btn btn-default" data-bs-toggle="modal"
                                                                    data-bs-target="#editModal">
                                                                Report
...
<!--                                        <button class="fas fa-solid fa-share" onclick="openModalShare(${post.originalId})" style="border: 0">Share</button>-->
            ...
            <!--                                        <button class="fas fa-solid fa-share" onclick="openModalShare(${post.originalId})" style="border: 0">Share</button>-->
                                    ...
                                    <div class="list-comments">
                                        <c:forEach items="${post.listCmt}" var="listCmt">
                                            <div class="comment">
                                                ...
                                                <c:if test="${ listCmt.user_cmt != name.getEmail() }">
                                                    <div class="dropdown comment-menu">
                                                        <button class="btn" type="button" id="dropdownMenuCmtButton" data-bs-toggle="dropdown"
                                                                aria-expanded="false">
                                                            <i class="fas fa-ellipsis-h"></i>
                                    ...
                                    <form action="Home" method="POST" id="postCommentForm${post.id}">
            ...
            <div class="right-home col-3 ">
                ...
                <h4 style="text-align: center; font-weight: bold">People you may know</h4>
                <div class="friend-list">
                    <ul>
                        <c:if test="${not empty proposelist}">
                            <c:forEach items="${proposelist}" var="pr">
                                <li class="user">
                                    ...
                                    <span class="username">
                                        <a href="Friend?action=loadFriend&fid=${pr.friend_email}">
                                            ${pr.firstname} ${pr.lastname}
                                        </a>
                                    </span>
                                        <button style="background-color: limegreen">
                                            <a style="text-decoration: none; color: black" href="Friend?action=loadFriend&fid=${pr.friend_email}">
                                            View
                                        </a>
                                    </button>
                                </li>
        ...
        <!-- Modal Post Share Home-->
        <div class="share-post modal fade" id="myModalShare_Home" role="dialog">
            <div class="modal-dialog">
                <form action="Home" method="Post">
                    <input type="hidden" name="postId" value="${p.id}">
                    <div class="modal-content modal-content-post">
                        <div class="modal-header post-share-header">
        ...
        <script>
            function openModalShare(postId) {
                ...
                document.querySelector('#myModalShare_Home input[name="postId"]').value = postId;
                // Mở modal
                var myModal = new bootstrap.Modal(document.getElementById('myModalShare_Home'));
                myModal.show();
            }
        </script>
            ...
            <c:forEach items="${posts}" var="p">
                ...
                if (editButton) {
                    editButton.addEventListener('click', function () {
                        ...
                        var formHtml = '<form action="Home" method="POST">\
